...
public class Ellipse {
    ...
    public Ellipse(PApplet p, float x, float y, float width, float height, int fillColor, int strokeColor) {
        parent = p;
        this.x = x;
        this.y = y;
        this.width = width;
    ...
    public Ellipse(PApplet p, float x, float y, float width, float height, int fillColor) {
        this(p, x, y, width, height, fillColor, 0);
    }

    public Ellipse(PApplet p, float x, float y, float width, float height, int fillRed, int fillGreen, int fillBlue,
    ...
    public Ellipse(PApplet p, float x, float y, float width, float height) {
        this(p, x, y, width, height, 0, 0, 0, 0, 0, 0);

    }

    public Ellipse(PApplet p, float x, float y, float width, float height, int r, int g, int b) {
